var sultans = [
{
  ...
  bio:   "<a href=\"http://phpied.com\">Stoyan</a> (<a href=\"http://twitter.com/stoyanstefanov\">@stoyanstefanov</a>) is a frontend engineer, writer (\"JavaScript Patterns\", \"Object-Oriented JavaScript\"), speaker (JSConf, Velocity, Fronteers), toolmaker (Smush.it, YSlow 2.0) and a guitar hero <a href=\"http://givepngachance.com\">wannabe</a>."
},
{
  url:   "http://wait-till-i.com/",
  name:  "Christian Heilmann",
  photo: "http://calendar.perfplanet.com/photos/christian.jpg",
  bio:   "Chris Heilmann is a self confessed data junkie and worked for over 12 years as a professional web developer. Having published several books on JavaScript, Accessibility and web development using web services he right now works as a developer evangelist for the Yahoo Developer Network. He blogs at <a href=\"http://wait-till-i.com/\">http://wait-till-i.com/</a>, has all his talks and videos at <a href=\"http://icant.co.uk/\">http://icant.co.uk/</a> and can be found on Twitter as <a href=\"http://twitter.com/codepo8\">@codepo8</a>."
},
{
  name: "Ara Pehlivanian",
  url: "http://arapehlivanian.com/",
  photo: "http://calendar.perfplanet.com/wp-content/uploads/2009/12/ara.jpg",
  bio: "Ara Pehlivanian has been working on the Web since 1997. He's been a freelancer, a webmaster, and most recently, a Front End Engineer at Yahoo! Ara's experience comes from having worked on every aspect of web development throughout his career, but he's now following his passion for web standards-based front-end development. When he isn't speaking and writing about best practices or coding professionally, he's either tweeting as <a href=\"http://twitter.com/ara_p\">@ara_p</a> or maintaining his personal site at <a href=\"http://arapehlivanian.com/\">http://arapehlivanian.com/</a>"
},
{
  name: "Eric Goldsmith",
  url: "http://ericgoldsmith.com",
  photo: "http://calendar.perfplanet.com/photos/eric.jpg",
...
{
  name: "Carlos Bueno",
  url: "http://carlos.bueno.org/",
  photo: "http://calendar.perfplanet.com/photos/carlos.jpg",
  bio: "<a href=\"\">Carlos Bueno</a> is an engineer at Facebook, where he helps paint on the go-faster stripes. His long-term project is to build a <a href=\"http://carlos.bueno.org/2008/08/save-web.html\">network</a> of independent, redundant, <a href=\"http://paperinternet.org/\">internet archives</a>."
},
{
  name: "Éric Daspet",
...
},
{
  ...
  photo: "http://calendar.perfplanet.com/photos/wim.jpg",
  bio: "<a href=\"http://wimleers.com\">Wim Leers</a> (<a href=\"http://twitter.com/wimleers\">@wimleers</a>) is a 22-year old Computer Science student and is currently finishing a Databases master at <a href=\"http://www.uhasselt.be\">Hasselt University</a> in Belgium, where he is now working hard on his <a href=\"http://wimleers.com/blog/master-thesis-literature-study-successfully-completed\">master thesis on WPO analytics</a>. He did his <a href=\"http://wimleers.com/blog/bachelor-thesis-finished\">bachelor thesis</a> on improving <a href=\"http://drupal.org\">Drupal</a>'s page loading performance and wrote the <a href=\"http://fileconveyor.org\">FileConveyor</a> daemon to detect, process and sync files to CDNs or static file servers. He has been <a href=\"http://drupal.org/user/99777\">contributing</a> to Drupal for almost 4 years, where he is now mostly evangelizing WPO."
},
{
  name: "Tim Kadlec",
...
},
{
  ...
  bio: "<a href=\"http://twitter.com/marcelduran\">Marcel Duran</a> is currently a Front End Engineer at Twitter Inc. Prior to that he had been into web performance optimization on high traffic websites at Yahoo! Front Page and Search teams where he applied and researched web performance best practices making pages even faster. On his last role as the Front End Lead for <a href=\"http://developer.yahoo.com/performance/\">Yahoo!’s Exceptional Performance Team</a> he was dedicated to <a href=\"http://yslow.org\">YSlow</a> (now as his personal <a href=\"https://github.com/marcelduran/yslow\">opensource project</a>) and other performance tools development, researches and evangelism."
},
{
  name: "Aaron Peters",
  url: "http://www.aaronpeters.nl",
  photo: "http://calendar.perfplanet.com/photos/aaron.jpg",
  bio: "<a href=\"http://www.aaronpeters.nl/en/\">Aaron Peters</a> (<a href=\"http://twitter.com/aaronpeters\">@aaronpeters</a>) is an independent web performance consultant based in The Netherlands. He is a Red Hot Chili Peppers fan and will kick your butt in a snowboard contest anytime."
},
{
  name: "Kyle Simpson",
  url: "http://blog.getify.com/",
  photo: "http://calendar.perfplanet.com/photos/kyle.jpg",
  bio: "<a href=\"http://blog.getify.com/\">Kyle Simpson</a> (<a href=\"http://twitter.com/getify\">@getify</a>) is a JavaScript Systems Architect from Austin, TX. He focuses on JavaScript, web performance optimization, and \"middle-end\" application architecture. If something can't be done in JavaScript or web stack technology, he's probably bored by it. He runs several open-source projects, including <a href=\"http://labjs.com\">LABjs</a>, <a href=\"http://handlebarjs.com/\">HandlebarJS</a>, and <a href=\"http://bikechainjs.com/\">BikechainJS</a>. Kyle is a Senior Architect for client and server side JavaScript for appendTo, LLC."
},
{
...
{
  name: "Hedger Wang",
  url: "http://hedgerwow.blogspot.com/",
  photo: "http://calendar.perfplanet.com/photos/hedger.jpg",
  bio: "<a href=\"http://hedgerwow.blogspot.com/\">Hedger Wang</a><br>HTML/CSS/JS Fanboy. <br><br>Hedger Wang used to work on Yahoo! as Frontend Tech Lead and now he works for Google and continue working on several big projects as UI Developer."
},
{
  name: "Sergey Chikuyonok",
  url: "http://chikuyonok.ru/",
  photo: "http://calendar.perfplanet.com/photos/chikuyonok.jpg",
  bio: "<a href=\"http://chikuyonok.ru/\">Sergey Chikuyonok</a> (<a href=\"http://twitter.com/chikuyonok\">@chikuyonok</a>) is an image optimization <a href=\"http://www.smashingmagazine.com/author/sergey-chikuyonok/\">expert</a> and mobile performance explorer."
},
{
  name: "David Calhoun",
  url: "http://davidbcalhoun.com",
  photo: "http://calendar.perfplanet.com/photos/calhoun.jpg",
  bio: "David Calhoun is a frontend engineer working for Yahoo! in Sunnyvale, and until recently was working on the Mobile team. He has a passion for all things frontend in general. He maintains a <a href=\"http://davidbcalhoun.com\">developer blog at davidbcalhoun.com</a> and can be reached through Twitter (<a href=\"http://twitter.com/franksvalli\">@franksvalli</a>)."
},
{
  name: "Nicholas Zakas",
  url: "http://www.nczonline.net/",
  photo: "http://calendar.perfplanet.com/photos/nicholas.jpg",
  bio: "Nicholas C. Zakas is a principal engineer at Yahoo!, where he is front-end tech lead for the Yahoo! homepage and a contributor to the YUI library. He is the author of Professional JavaScript for Web Developers (Wrox, 2009), Professional Ajax (Wrox, 2007), and High Performance JavaScript (O&#39;Reilly, 2010). Nicholas is a strong advocate for development best practices including progressive enhancement, accessibility, performance, scalability, and maintainability. He blogs regularly at <a href=\"http://www.nczonline.net/\">http://www.nczonline.net/</a> and can be found on Twitter via <a href=\"http://twitter.com/slicknet\">@slicknet</a>."
},
{
  name: "Tony Gentilcore",
  url: "http://gent.ilcore.com",
...
{
  name: "Ben Cherry",
  url: "http://www.adequatelygood.com",
  photo: "http://calendar.perfplanet.com/photos/ben.jpg",
  bio: "<a href=\"http://www.adequatelygood.com\">Ben Cherry</a> (<a href=\"http://twitter.com/bcherry\">@bcherry</a>) is a front-end engineer at Twitter, where he helped build the new <a href=\"http://twitter.com\">Twitter.com</a>."
},
{
...
{
  name: "Kyle Scholz",
  url: "http://www.kylescholz.com",
  photo: "http://calendar.perfplanet.com/photos/kyles.jpg",
...
{
  name: "Lindsey Simon",
  url: "http://www.dishola.com/",
  photo: "http://calendar.perfplanet.com/photos/lindsey.jpg",
  bio: "<a href=\"http://www.dishola.com/\">Lindsey Simon</a> (<a href=\"http://twitter.com/elsighmon\">@elsighmon</a>) is a front-end developer for Googleâ€™s User Experience group and project lead for the open source <a href=\"Browserscope.org\">Browserscope.org</a> project. Dude hails from Austin, TX where he toiled at a few startups, taught computing at the Griffin School, and worked as webmaster for the Austin Chronicle. He currently lives in San Francisco, writes <a href=\"http://www.unsignedbandweb.com/music/bands/15043/\">acoustic guitar songs</a>, and helps run a foodie website <a href=\"http://dishola.com\">dishola.com</a>."
},
{
  name: "Bryan McQuade",
  url: "http://bryanmcquade.com/blog/",
  photo: "http://calendar.perfplanet.com/photos/bryan180.jpg",
  bio: "<a href=\"http://bryanmcquade.com/blog/\">Bryan McQuade</a> (<a href=\"http://twitter.com/bryanmcquade\">@bryanmcquade</a>) leads the Page Speed team at Google. He has contributed to various projects that make the web faster, including Shared Dictionary Compression over HTTP and optimizing web servers to better utilize HTTP."
},
{
  name: "Libo Song",
  url: "http://code.google.com/speed/page-speed/",
  photo: "http://calendar.perfplanet.com/photos/libo180.jpg",
  bio: "Libo Song is a Software Engineer at Google. He is a member of the Page Speed team. Recently, he helped launch mod_pagespeed."
},
{
  name: "Joshua Bixby",
  url: "http://www.webperformancetoday.com/",
  photo: "http://calendar.perfplanet.com/photos/joshua.jpg",
  bio: "<a href=\"http://www.webperformancetoday.com/\">Joshua Bixby</a> (<a href=\"http://twitter.com/JoshuaBixby\">@JoshuaBixby</a>) - by day, president of <a href=\"http://strangeloopnetworks.com/\">Strangeloop</a>, a company that designs and implements site acceleration solutions. By night, he mines data about web performance and its impact on users."
},
{
  name: "Philip Tellis",
  url: "http://bluesmoon.info",
  photo: "http://calendar.perfplanet.com/photos/philip.jpg",
  bio: "<a href=\"http://bluesmoon.info/\">Philip Tellis</a> (<a href=\"http://twitter.com/bluesmoon\">@bluesmoon</a>) is a geek living and working in California's Silicon Valley.  He works with  <a href=\"http://developer.yahoo.com/performance/\">Yahoo!'s performance</a> and <a href=\"http://security.yahoo.com/\">security</a> groups  on measuring and improving the performance and security of Yahoo!'s websites.  Philip writes code because it's fun to do.  He loves making computers do his work for him and spends a lot of time trying to get the most out of available hardware.  He is equally comfortable with the back end and the front end and his <a href=\"http://tech.bluesmoon.info/\">tech blog</a>  has articles ranging from <a href=\"http://tech.bluesmoon.info/search/label/freebsd\">Operating</a> <a href=\"http://tech.bluesmoon.info/search/label/linux\">System</a> level hacks to  <a href=\"http://tech.bluesmoon.info/search/label/accessibility\">Accessibility</a> in Rich Internet Applications."
},
{
  name: "Mathias Bynens",
  url: "http://mathiasbynens.be/",
  photo: "http://calendar.perfplanet.com/photos/mathias.jpg",
  bio: "<a href=\"http://mathiasbynens.be/\">Mathias Bynens</a> (<a href=\"http://twitter.com/mathias\">@mathias</a>) works as a freelance web developer in Belgium. He likes HTML, CSS,  JavaScript and WPO. To help with those last two things, he created <a  href=\"http://jsperf.com/\" title=\"JavaScript performance testing made  easy\">jsPerf</a> a while ago."
},
{
